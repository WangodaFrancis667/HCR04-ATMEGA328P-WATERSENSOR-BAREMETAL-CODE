# Makefile for HC-SR04 ATmega328P Water Level Sensor (Timer1 Implementation)
# Target: ATmega328P (Arduino Uno) with PlatformIO
# Project: Advanced Water Level Monitoring with Timer1 Input Capture
...
build:
	@echo "Building HC-SR04 Water Level Sensor (Timer1 Implementation)..."
...
upload: build
	@echo "Uploading to ATmega328P (Arduino Uno)..."
	$(UPLOAD_CMD)
...
status:
	@echo "=== HC-SR04 Water Level Sensor Project Status ==="
	@echo "Project: $(PROJECT_NAME)"
...
help:
	@echo "HC-SR04 ATmega328P Water Level Sensor Makefile"
	@echo "=============================================="
	@echo ""
